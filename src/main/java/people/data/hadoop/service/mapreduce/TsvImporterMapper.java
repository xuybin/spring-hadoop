...
import people.data.hadoop.service.mapreduce.ImportTsv.TsvParser.BadTsvLineException;
    ...
    try {
      ...
      for (int i = 0; i < parsed.getColumnCount(); i++) {
        if (i == parser.getRowKeyColumnIndex() || i == parser.getTimestampKeyColumnIndex()
            ...
            || i == parser.getCellTTLColumnIndex()|| (skipEmptyColumns && (parsed.getColumnLength(i) == 0 || value.toString().trim().equalsIgnoreCase("null") ))) {
          continue;
        }
